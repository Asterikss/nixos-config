vim.api.nvim_set_hl(0, 'CustomBullet1', { fg = '#fe6d73' })
vim.api.nvim_set_hl(0, 'CustomBullet2', { fg = '#f4acb7' })
vim.api.nvim_set_hl(0, 'CustomBullet3', { fg = '#ff7b00' })
vim.api.nvim_set_hl(0, 'CustomBullet4', { fg = '#ffd6ba' })
vim.api.nvim_set_hl(0, '@custom.setex.heading.2', { fg = '#fe6d73' })
